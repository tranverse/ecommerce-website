...
function Header() {
    ...
    return (
        <header className="mx-auto md:px-10 px-4 pt-2 top-0 z-50 left-0 right-0 fixed shadow bg-white ">
            <div className="flex justify-between items-center gap-2">
                <Link to={'/'}>
                    <div className="flex  items-center cursor-pointer">
                        ...
                        <p className="text-[var(--primary)] text-3xl md:text-4xl- font-bold ml-2">
                            OwnFit
                        </p>
                    </div>
                </Link>
                ...
                <div className="">
                    <div className="hidden md:flex items-center justify-between">
                        ...
                        <div className="p-1">
                            <PiShoppingCartThin className="text-3xl text-[var(--primary)] cursor-pointer" />
                        </div>
                    </div>
                    <button
