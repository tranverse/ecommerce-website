...
const ProductDetail = () => {
    ...
    const handleAddProductToCart = async () => {
        const payload = {
            ...
            quantity: quantity,
            customer: { id: 'e44f65c3-bb15-48d9-8f9a-4ce71484b681' },
        };
        await dispatch(addProductToCart(payload));
        await dispatch(fetchCart('e44f65c3-bb15-48d9-8f9a-4ce71484b681'));
    };

    console.log(chosenVariant);
    return (
        <div className="md:mt-31 mt-25 grid grid-cols-1 md:grid-cols-[2fr_2.5fr] md:gap-5 gap-4 px-2 rounded-lg  py-4 bg-white">
                ...
                <div className="flex items-center gap-2 text-[var(--primary)] bg-gray-50 p-4 mb-4">
                    ...
                    {product?.discountPercentage > 0 && (
                        <>
                            ...
                            <p className="bg-[var(--primary)] px-1 text-white text-sm">
